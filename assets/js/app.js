...
// Tutor helped here but need to study this code.
...
function visualize(theData) {
  ...
  d3.selectAll(".aText").on("click", function() {
    ...
    var self = d3.select(this);
      ...
      if (axis === "x") {
        ...
        // To change the location of the state texts, too.
        ...
        d3.selectAll(".stateText").each(function() {
          //State text the same motion tween as the matching circle.
          d3
            .select(this)
            .transition()
            .attr("dy", function(d) {
  ...
  // Mobile Compatability-Tutor helped with this!!!!
  ...
  function resize() {
    ...
    // Location and size of the state texts, too.
    d3
      .selectAll(".stateText")
      .attr("dy", function(d) {
        return yScale(d[curY]) + circRadius / 3;
